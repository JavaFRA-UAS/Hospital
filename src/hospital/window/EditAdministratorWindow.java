...
public class EditAdministratorWindow extends JFrame {
	...
	private Administrator row;
	DatePicker datePickerTimeOfBirth;

	public EditAdministratorWindow(RefreshableWindow parentWindow) {
		this.parentWindow = parentWindow;
		final EditAdministratorWindow window = this;
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Administrator.getFactory().save(row);
	...
	public void setAdministrator(Administrator p) {
		this.row = p;
